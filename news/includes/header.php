   ...
   <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarResponsive">
         <ul class="navbar-nav">
            ...
            <li class="nav-item">
               <a class="nav-link" href="https://www.nytimes.com/crosswords"><i class="fa fa-trophy"></i> Games</a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="admin/index.php"><i class="fa fa-user"></i> login</a>
            </li>
         </ul>
      </div>
      <div>
