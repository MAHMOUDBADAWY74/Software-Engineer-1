            ...
            <div class="col-md-4">
               <div class="card-box h-100">
                  <div class="card-header">
                     <h2 class="card-title mb-2">Welcome in our website</h2>
                  </div>
                  <br><br>
                  <div class="card-body">
                     <div class="row ">
                        <div class="col-md-6">
                           <br>
                           <br>
                           <a href="../index.php" target="a_blank" class="btn btn-sm btn-primary">Home page</a>
                        </div>
                        <div class="col-md-6">
                           <img src="assets/images/Desktop-Laptop-and-Tablet.png" width="140" height="150" class="rounded-start">
                        </div>
                     </div>
                  </div>
               </div>
